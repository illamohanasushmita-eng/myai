    ...
    <>
      <div className="relative flex h-auto min-h-screen w-full flex-col justify-between overflow-x-hidden bg-background-light font-sans dark:bg-background-dark">
            ...
            <section className="mb-6">
              <div className="mx-auto mb-6 flex w-fit rounded-lg bg-white/60 p-1 dark:bg-gray-700/60">
                <button
                  ...
                  className={`rounded-md px-4 py-2 text-sm font-semibold transition-colors ${view === "list" ? "bg-primary text-white shadow" : "text-gray-600 dark:text-gray-300"}`}
                >
                  List
                </button>
                <button
                  onClick={() => setView("calendar")}
                  className={`rounded-md px-4 py-2 text-sm font-semibold transition-colors ${view === "calendar" ? "bg-primary text-white shadow" : "text-gray-600 dark:text-gray-300"}`}
                >
                  Calendar
                </button>
              </div>
                    ...
                    <section className="mb-8">
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-300">
                          You've completed {completedCount} of {tasks.length}{" "}
                          tasks.
                        </p>
                      </div>
        ...
        <div className="fixed bottom-24 left-4 z-20">
          <Button
            asChild
            className="flex items-center gap-2 rounded-full bg-primary px-4 py-3 text-white shadow-lg transition-transform hover:scale-105 active:scale-95"
          >
            <Link href="/tasks/add">
              <svg
                fill="currentColor"
