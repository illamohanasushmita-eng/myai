...
const plans = {
  monthly: [
    ...
    },
    {
      ...
      period: "/month",
      description:
        "For professionals who need more power and features in the future.",
      features: [
      ...
      <main className="flex-grow p-6 text-center space-y-8">
        <div>
          ...
          <p className="mt-2 text-subtle-light dark:text-subtle-dark">
            MyAI is currently free for everyone. Pro plans are for future
            versions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {(billingCycle === "monthly" ? plans.monthly : plans.yearly).map(
            (plan) => (
              <div
                key={plan.name}
                className={cn(
                  "p-6 rounded-xl border-2 flex flex-col",
                  plan.isCurrent
              ...
              >
                ...
                <p className="mt-2 text-subtle-light dark:text-subtle-dark h-12">
                  {plan.description}
                </p>
                <div className="my-6">
