  ...
  const handleExport = () => {
    const data = {
      ...
      tasks: [
        ...
        {
          id: 2,
          title: "Prepare slides for Q4 presentation",
          status: "pending",
        },
      ],
      settings: {
    ...
    <div className="flex flex-col h-screen bg-background-light dark:bg-background-dark text-foreground-light dark:text-foreground-dark">
      ...
      <main className="flex-grow p-6 space-y-6">
        ...
        <div className="p-4 rounded-lg bg-primary/10 dark:bg-primary/20 text-sm text-foreground-light/80 dark:text-foreground-dark/80">
          <p>
            <span className="font-bold text-primary">Export Your Data:</span>{" "}
            Download a JSON file containing all your profile information, tasks,
            and settings.
          </p>
          <p className="mt-2">
            ...
            Be careful, this action is irreversible and will permanently erase
            all your data.
          </p>
        </div>
      </main>
