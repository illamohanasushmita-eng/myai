...
import { getUserSymptoms, getUserMedications, getUserAppointments, deleteMedication, deleteAppointment } from "@/lib/services/healthRecordService";
...
export default function HealthcarePage() {
  ...
  const handleEditMedication = (medicationId: string) => {
    router.push(`/healthcare/edit-medication/${medicationId}`);
  };
  ...
  const handleEditAppointment = (appointmentId: string) => {
    router.push(`/healthcare/edit-appointment/${appointmentId}`);
  };
        ...
        <div className="p-6">
          ...
          <div className="mt-6">
            <div className="flex justify-between items-center mb-4">
              ...
              >
                <Link href="/healthcare/add-symptom">
                          ...
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button
                                variant="ghost"
                                size="icon"
                                className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-black/5 dark:hover:bg-white/5"
                              >
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => handleEditMedication(medication.medication_id)}>
                                <span className="material-symbols-outlined mr-2 text-blue-500">edit</span>
                                Edit
                              </DropdownMenuItem>
                              <DropdownMenuItem className="text-destructive" onClick={() => handleDeleteMedication(medication.medication_id)}>
                    ...
                    <div className={index > 0 ? 'pt-4' : ''}>
                      <div className="flex items-center gap-4">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => handleEditAppointment(appointment.appointment_id)}>
                              <span className="material-symbols-outlined mr-2 text-blue-500">edit</span>
                              Edit
                            </DropdownMenuItem>
                            <DropdownMenuItem className="text-destructive" onClick={() => handleDeleteAppointment(appointment.appointment_id)}>
                              <span className="material-symbols-outlined mr-2">delete</span>
                              Delete
                            </DropdownMenuItem>
                          </DropdownMenuContent>
