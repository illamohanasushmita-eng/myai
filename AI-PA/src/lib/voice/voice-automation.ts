...
export function detectWakeWord(text: string, wakeWord: string = 'hey lara'): boolean {
...
export async function speakResponse(text: string, language: string = 'en-US'): Promise<void> {
