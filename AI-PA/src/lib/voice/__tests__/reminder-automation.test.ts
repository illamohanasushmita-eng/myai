...
import { getNextDayOfWeek, convertToISOTimestamp, parseTimeFromText } from '../reminder-automation';
...
describe('Reminder Automation - Date Calculation', () => {
  ...
  describe('Integration Tests', () => {
    ...
    it('should create reminder for "remind me to call my mom tomorrow at 5:30 PM"', () => {
      const result = convertToISOTimestamp('remind me to call my mom tomorrow at 5:30 PM');
      const resultDate = new Date(result);
    ...
    it('should create reminder for "remind me to call my mom Friday at 3 PM"', () => {
      const result = convertToISOTimestamp('remind me to call my mom Friday at 3 PM');
      const resultDate = new Date(result);
