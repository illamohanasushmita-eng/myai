...
export default function TaskCalendar({ tasks, onTaskSelect }: TaskCalendarProps) {
        ...
        {taskCount > 0 && (
          <div className="flex gap-0.5 mt-0.5">
            {taskCount <= 3 ? (
              ...
              <span className="text-xs font-semibold text-primary">{taskCount}</span>
            )}
          </div>
        )}
      </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        <h2 className="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Upcoming Tasks</h2>
        <div className="space-y-3">
          {tasks
            .filter(task => {
