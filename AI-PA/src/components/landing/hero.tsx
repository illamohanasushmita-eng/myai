...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center px-6 py-8 text-center max-w-3xl mx-auto">
        ...
        <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 mb-6 max-w-2xl">
          Manage your day effortlessly. Plan your schedule, set reminders, use voice commands, and get personalized insights.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Button asChild size="lg" className="h-12 px-8 text-base font-bold shadow-lg shadow-primary/20">
            <Link href="/signin">Get Started</Link>
          </Button>
          <Button asChild size="lg" variant="secondary" className="h-12 px-8 text-base font-bold bg-primary/10 dark:bg-primary/20 text-primary hover:bg-primary/20 dark:hover:bg-primary/30">
