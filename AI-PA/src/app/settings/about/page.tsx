  ...
  return (
    <div className="flex flex-col h-screen bg-background-light dark:bg-background-dark text-foreground-light dark:text-foreground-dark">
      ...
      <main className="flex-grow p-6 text-center space-y-4">
        ...
        <p>Version 1.0.0</p>
        <p className="text-subtle-light dark:text-subtle-dark">Your personal AI assistant to organize your life.</p>
        <div className="py-4">
          <Link href="#" className="text-primary">Terms of Service</Link>
