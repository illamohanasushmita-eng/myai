        ...
        <div className="p-4 rounded-lg bg-card-light dark:bg-card-dark">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-subtle-light dark:text-subtle-dark">Receive alerts on your device.</p>
                </div>
         ...
         <div className="p-4 rounded-lg bg-card-light dark:bg-card-dark">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-subtle-light dark:text-subtle-dark">Get updates in your inbox.</p>
                </div>
                <Switch />
            </div>
        </div>
        <div className="p-4 rounded-lg bg-card-light dark:bg-card-dark">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-subtle-light dark:text-subtle-dark">Alerts for upcoming deadlines.</p>
                </div>
                <Switch defaultChecked/>
            </div>
        </div>
        <div className="p-4 rounded-lg bg-card-light dark:bg-card-dark">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-subtle-light dark:text-subtle-dark">News about features and offers.</p>
                </div>
                <Switch />
            </div>
        </div>
