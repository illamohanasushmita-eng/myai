  ...
  return (
    <div className="flex flex-col h-screen bg-background-light dark:bg-background-dark text-foreground-light dark:text-foreground-dark">
      ...
      <main className="flex-grow p-6 space-y-4">
        <Input placeholder="Your Email" type="email" className="bg-input-light dark:bg-input-dark" />
        <Input placeholder="Subject" className="bg-input-light dark:bg-input-dark" />
        <Textarea placeholder="Your message..." className="bg-input-light dark:bg-input-dark" />
      </main>
